...
from ansible.module_utils.tetration.api import TETRATION_API_INVENTORY_TAG, TETRATION_COLUMN_NAMES
...
def main():
    ...
    argument_spec = dict(
        ...
        state=dict(default='present', choices=['present', 'absent', 'query', 'delete_columns'])
    )
